    ...
    return window.innerWidth < 700
      ? html`
          <div class="headerCont">
            <img
              src="assets/IMG_20190901_155836_058.jpg"
              alt="Tarrin Neal"
              width="150"
              height="150"
              class="headshot"
            ...
            <div class="headerWords">
              ...
              <h3 class="header title">Full Stack Software Engineer</h3>
            </div>
          </div>
        `
      : html`
          <div class="headerCont">
            <div class="headerInnerCont">
              <img
                src="assets/IMG_20190901_155836_058.jpg"
                alt="Tarrin Neal"
                width="150"
              ...
              <div class="header button-container">
                <p class="contact content">
                  ...
                  <a href="tel:+1-360-624-2170">(360) 624-2170</a>
                  <br />
                  <br />
                  <svg
                    aria-hidden="true"
                  ...
                  <a href="mailto:tarrinneal@gmail.com">Tarrinneal@gmail.com</a>
                  <br />
                  <br />
                  <svg
                    aria-hidden="true"
                  ...
                  <svg
                    ...
                    class="svg-inline--fa fa-github-square"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                  >
                  ...
                  <a href="https://github.com/tarrinneal" target="_blank"
                    >github.com/tarrinneal</a
                  >
                </p>
              </div>
            </div>
